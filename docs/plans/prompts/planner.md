...
Với plan UI/workflow có nhiều phase, planner phải nhóm phase thành các bundle review được và định nghĩa Human Review Gate. Gate là dependency bắt buộc nhưng không tạo phase/file riêng. Phase trong cùng bundle có thể nối tiếp bằng automated pass; phase đầu bundle kế tiếp chỉ mở sau xác nhận rõ của user tại gate.
...
13. Với UI/workflow nhiều phase, định nghĩa Human Review Gate sau các bundle có thể chạy được; ghi gate trong phase table và `02-coordination.md`, không tạo file gate riêng.
...
- [ ] Plan UI/workflow nhiều phase có Human Gate vừa đủ, mỗi gate có scope thao tác và dependency kế tiếp đo được.
...
- dồn mọi manual UI review về phase cuối dù các bundle trước đã chạy được;
- tạo Human Gate thành folder/file/phase giả hoặc coi chờ user review là blocker kỹ thuật.
