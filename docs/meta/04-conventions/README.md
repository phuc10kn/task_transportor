...
| [folder-naming.md](folder-naming.md) | Folder naming |
| [file-naming.md](file-naming.md) | File naming |
| [metadata-format.md](metadata-format.md) | YAML frontmatter |
| [status-vocabulary.md](status-vocabulary.md) | Status values |
| [readme-structure.md](readme-structure.md) | Entity README template |
| [reference-format.md](reference-format.md) | Cross-references |
