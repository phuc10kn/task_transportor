...
- app truth hiện tại;
- routing ngắn tới folder structure, entity type canonical và relation rule canonical;
...
Layer README phải dùng path chuẩn có prefix số từ `docs/guide/reference/folder-structure.md`, ví dụ:
...
| Folder structure đúng | Concern path dùng prefix số đúng với `docs/guide/reference/folder-structure.md`. |
| Routing concern còn rõ | README trỏ tới folder structure canonical của layer. |
