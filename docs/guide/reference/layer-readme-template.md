...
Layer README sau cleanup vẫn là entry point của layer, nhưng không dạy lại toàn bộ documentation system. Universal layer/concern baseline nằm ở:
...
Layer này giữ <loại app knowledge> của <Project Name>.

Để hiểu mô hình layer/entity/relation và universal layer/concern baseline, đọc:
...
| Cần tìm | Đọc |
| --- | --- |
| Universal concern baseline của layer | Heading layer tương ứng trong [folder-structure.md](folder-structure.md) |
...
- <Loại nội dung chưa thuộc canonical home của layer.>
```
