...
`05-architecture/` là source of truth cho cách `task_transportor` áp dụng custom modular monolith và mô hình Central Sync Hub. File này giữ app-specific architecture truth; taxonomy reusable nằm ở `docs/app_technical/custom_modular_monolith/`, theory nền nằm ở `docs/theories/`.
...
- Architecture template reusable: `docs/app_technical/custom_modular_monolith/05-architecture/README.md`
...
Phase 02 chốt cách app áp dụng custom modular monolith:
...
- Principle reusable lặp lại cho nhiều repo thuộc `docs/theories/` và template reusable thuộc `docs/app_technical/custom_modular_monolith/`.
